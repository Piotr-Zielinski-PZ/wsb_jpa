...
public class PatientDaoImpl extends AbstractDao<PatientEntity, Long> implements PatientDao {
    ...
    @Override
    public List<PatientEntity> findPatientByHasBeenVaccinated(char hasBeenVaccinated) {
        return entityManager.createQuery("SELECT patient FROM PatientEntity patient WHERE hasBeenVaccinated = :hasBeenVaccinated",
                        PatientEntity.class).setParameter("hasBeenVaccinated", hasBeenVaccinated).getResultList();
    }
