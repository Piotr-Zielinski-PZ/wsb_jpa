...
public class PatientDaoTest {
    ...
    @Test
    @Transactional
    public void findPatientsThatHaveBeenVaccinatedShouldReturnPatientsThatHaveBeenVaccinated() {
        char hasBeenVaccinated = 'Y';
        List<PatientEntity> patients = patientDao.findPatientByHasBeenVaccinated(hasBeenVaccinated);
        assertThat(patients).isNotEmpty();
        patients.forEach(patient ->
                assertThat(patient.getHasBeenVaccinated()).isEqualTo(hasBeenVaccinated));
    }
}